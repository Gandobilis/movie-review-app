                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0;font-size:0">
                                                                <img class="adapt-img"
                                                                     src="https://fcohair.stripocdn.email/content/guids/CABINET_4e7e5ef586c39a506ab7878ebd789e9f38a89186d3d68db91eaaec1b1a18cd3f/images/0moviereviewappthumb.jpeg"
                                                                     alt="" width="180" height="101"
                                                ...
                                                <td valign="top" align="center" style="padding:0;Margin:0;width:560px">
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0"><p
                                                                    style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                    We are excited to welcome you to MRA! Your
                                                                    account has been created, and here are your login
                                                                    credentials:</p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0"> <!--[if mso]>
                                                                <a href="http://127.0.0.1:8000/api" target="_blank"
                                                                   hidden>
                                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                                 ...
                                                                                 style="height:39px; v-text-anchor:middle; width:150px"
                                                                                 arcsize="50%" strokecolor="#2cb543"
                                                                                 strokeweight="2px" fillcolor="#31cb4b">
                                                                ...
                                                                <![endif]--> <!--[if !mso]><!-- --><span
                                                                    ...
                                                                    style="border-style:solid;border-color:#2CB543;background:#31CB4B;border-width:0px 0px 2px 0px;display:inline-block;border-radius:30px;width:auto;mso-hide:all"><a
                                                                        href="http://127.0.0.1:8000/api"
                                                                        class="es-button"
                                                                        target="_blank"
